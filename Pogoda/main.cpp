...
//        btn5 = new wxButton(this, wxID_ANY, "Show data files");
//
//        btn1->SetFont(wxFont(10, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD));
//        btn2->SetFont(wxFont(10, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD));
//        btn3->SetFont(wxFont(10, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD));
//        btn4->SetFont(wxFont(10, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD));
//        btn5->SetFont(wxFont(10, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD));
//
//        selectedStationText = new wxStaticText(this, wxID_ANY, "No station selected");
//        selectedStationText->SetFont(wxFont(9, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL));
//
//        selectedSensorText = new wxStaticText(this, wxID_ANY, "No sensor selected");
//        selectedSensorText->SetFont(wxFont(9, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL));
//
//        selectedFileText = new wxStaticText(this, wxID_ANY, "No file selected");
//        selectedFileText->SetFont(wxFont(9, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL));
//
//        btnSizer->Add(btn1, 0, wxALL | wxEXPAND, 10);
//        btnSizer->Add(btn2, 0, wxALL | wxEXPAND, 10);
//        btnSizer->Add(btn3, 0, wxALL | wxEXPAND, 10);
...
//        wxBusyCursor busy;
//
//        bool success = DownloadStationsData();
//
//        if (success) {
//            wxMessageBox("Successfully downloaded stations data and saved to pomiary/stacje.json", "Success", wxOK | wxICON_INFORMATION);
//        }
...
//        }
//
//        curl_easy_setopt(curl, CURLOPT_URL, STATIONS_API_URL.c_str());
//        curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION, WriteCallback);
...
//        }
//
//        std::ofstream file(STATIONS_FILE_PATH);
//        if (!file.is_open()) {
//            return false;
//        }
//
...
//        writerBuilder["indentation"] = "  ";
//        std::unique_ptr<Json::StreamWriter> writer(writerBuilder.newStreamWriter());
//        writer->write(filteredStations, &file);
//        file.close();
//
//        return true;
//    }
...
//
//        Json::Value stations;
//        std::ifstream file(STATIONS_FILE_PATH);
//        if (!file.is_open()) {
//            wxMessageBox("Could not open stations file.", "Error", wxOK | wxICON_ERROR);
//            return;
//        }
//
//        Json::CharReaderBuilder builder;
//        std::string errors;
//        bool parsingSuccessful = Json::parseFromStream(builder, file, &stations, &errors);
//        file.close();
//
//        if (!parsingSuccessful) {
//            wxMessageBox("Failed to parse stations data.", "Error", wxOK | wxICON_ERROR);
//            return;
//        }
//
//        StationSelectionDialog dialog(this, stations);
...
//        if (!std::filesystem::exists(sensorsFilePath)) {
//            wxBusyCursor busy;
//            if (!DownloadSensorsData(selectedStationId, sensorsFilePath)) {
//                wxMessageBox("Failed to download sensors data.", "Error", wxOK | wxICON_ERROR);
//                return;
//            }
//        }
//
//        Json::Value sensors;
//        std::ifstream file(sensorsFilePath);
//        if (!file.is_open()) {
//            wxMessageBox("Could not open sensors file.", "Error", wxOK | wxICON_ERROR);
//            return;
//        }
//
//        Json::CharReaderBuilder builder;
//        std::string errors;
//        bool parsingSuccessful = Json::parseFromStream(builder, file, &sensors, &errors);
//        file.close();
//
//        if (!parsingSuccessful) {
//            wxMessageBox("Failed to parse sensors data.", "Error", wxOK | wxICON_ERROR);
//            return;
//        }
//
//        SensorSelectionDialog dialog(this, sensors);
...
//    }
//
//    bool DownloadSensorsData(int stationId, const std::string& filePath) {
//        CURL* curl;
//        CURLcode res;
//        std::string readBuffer;
//
//        std::string apiUrl = "http://api.gios.gov.pl/pjp-api/rest/station/sensors/" + std::to_string(stationId);
//
//        curl = curl_easy_init();
//        if (!curl) {
//            return false;
...
//
//        std::string readBuffer;
//        if (!DownloadSensorData(selectedSensorId, readBuffer)) {
//            wxMessageBox("Failed to download sensor data.", "Error", wxOK | wxICON_ERROR);
//            return;
//        }
//
...
//    }
//
//    bool DownloadSensorData(int sensorId, std::string& outputBuffer) {
//        CURL* curl;
//        CURLcode res;
//
//        std::string apiUrl = "http://api.gios.gov.pl/pjp-api/rest/data/getData/" + std::to_string(sensorId);
//
//        curl = curl_easy_init();
//        if (!curl) {
//            return false;
...
//        std::ifstream file(filePath);
//        if (!file.is_open()) {
//            wxMessageBox("Could not open data file.", "Error", wxOK | wxICON_ERROR);
//            return;
//        }
//
//        Json::Value data;
//        Json::CharReaderBuilder builder;
//        std::string errors;
//        bool parsingSuccessful = Json::parseFromStream(builder, file, &data, &errors);
//        file.close();
//
//        if (!parsingSuccessful || !data.isMember("values") || !data["values"].isArray()) {
//            wxMessageBox("Failed to parse data file.", "Error", wxOK | wxICON_ERROR);
//            return;
//        }
//
//        std::string key = data.isMember("key") ? data["key"].asString() : "Unknown";
